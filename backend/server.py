...
from fastapi.responses import StreamingResponse, JSONResponse, Response, PlainTextResponse, HTMLResponse
...
async def register(request: Request, user: UserCreate, background_tasks: BackgroundTasks):
    ...
    # reCAPTCHA temporairement désactivé - à réactiver après investigation
