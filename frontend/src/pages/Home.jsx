      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-10 gap-4 md:gap-6">
            {[
              { name: 'Renault', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Renault_2009_logo.svg/200px-Renault_2009_logo.svg.png' },
              { name: 'Peugeot', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Peugeot_2010_logo.svg/200px-Peugeot_2010_logo.svg.png' },
              ...
              { name: 'Opel', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Opel_logo.svg/200px-Opel_logo.svg.png' },
              { name: 'Toyota', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Toyota_carance.svg/200px-Toyota_carance.svg.png' },
              ...
              { name: 'Fiat', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Fiat_Automobiles_logo.svg/200px-Fiat_Automobiles_logo.svg.png' },
              { name: 'Seat', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Seat_logo.svg/200px-Seat_logo.svg.png' },
              { name: 'Skoda', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Skoda_Auto_logo_%282022%29.svg/200px-Skoda_Auto_logo_%282022%29.svg.png' },
              ...
              { name: 'Dacia', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Dacia_Logo.svg/200px-Dacia_Logo.svg.png' },
              { name: 'Volvo', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Volvo_Cars_logo.svg/200px-Volvo_Cars_logo.svg.png' },
              { name: 'Mazda', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Mazda_logo_with_emblem.svg/200px-Mazda_logo_with_emblem.svg.png' },
            ].map((brand, index) => (
              <Link
                key={brand.name}
