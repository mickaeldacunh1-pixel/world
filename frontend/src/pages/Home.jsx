...
import { Search, Car, Wrench, Bike, Truck, Settings, ArrowRight, Shield, Users, Clock, MapPin, Eye, Sparkles, Gavel, Gift, UserPlus, Copy, Check, Stethoscope, MessageCircle, Crown, Tractor } from 'lucide-react';
...
import HeroFreePosition from '../components/HeroFreePosition';
import { toast } from 'sonner';

const API = `${process.env.REACT_APP_BACKEND_URL}/api`;

// Categories will be translated via t() function
const getCategoriesConfig = () => [
  { nameKey: 'categories.pieces', slug: 'pieces', icon: Wrench, image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=400&fit=crop', count: 0, color: 'from-orange-500 to-red-500' },
  { nameKey: 'categories.voitures', slug: 'voitures', icon: Car, image: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=600&h=400&fit=crop', count: 0, color: 'from-blue-500 to-indigo-500' },
  ...
  { nameKey: 'categories.engins', slug: 'engins', icon: Tractor, image: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=600&h=400&fit=crop', count: 0, color: 'from-lime-500 to-green-600' },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
            {[
              ...
              { nameKey: 'home.parts.suspension', subcategory: 'suspension', defaultImage: 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=200&h=150&fit=crop' },
              { nameKey: 'home.parts.exhaust', subcategory: 'echappement', defaultImage: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=200&h=150&fit=crop' },
              { nameKey: 'home.parts.interior', subcategory: 'interieur', defaultImage: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=200&h=150&fit=crop' },
            ].map((part) => {
              const imageKey = `pieces_${part.subcategory}`;
              const imageUrl = subcatImages[imageKey] || part.defaultImage;
              return (
              <Link
              ...
              >
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = part.defaultImage;
                    }}
                  />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                {heroSettings.diagnostic_title || t('home.diagnostic_title')}<br />
                <span className="text-accent">{heroSettings.diagnostic_subtitle || t('home.diagnostic_by_tobi')}</span>
              </h2>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 max-w-sm mx-auto">
                ...
                <div className="mt-4 pt-4 border-t border-white/10 text-center">
                  <p className="text-xs text-slate-400">
                    💡 <strong className="text-white">{heroSettings.diagnostic_price || '0.99'}€</strong> {t('home.per_diagnostic')} <strong className="text-green-400">{t('home.free')}</strong> {t('home.with_ad')}
                  </p>
                </div>
              </div>
            </div>
