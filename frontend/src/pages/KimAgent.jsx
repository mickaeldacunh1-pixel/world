...
export default function KimAgent() {
  ...
  const installOptions = [
    {
      ...
      steps: [
        'Ouvrez KIM Agent dans votre navigateur',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900" data-testid="kim-agent-page">
      <SEO
        title="KIM Agent - Assistant IA Automobile"
        description="Découvrez KIM Agent, votre assistant IA pour l'automobile. Diagnostic, recherche de pièces, conseils personnalisés."
      />
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <a href="/kim-agent/" target="_blank" rel="noopener noreferrer">
              ...
              <a href="/kim-agent/index.html" download="kim-agent.html">
              ...
              <Card key={option.id} className="bg-white/5 border-white/10 backdrop-blur-sm max-w-2xl mx-auto">
                <CardContent className="p-8">
                  ...
                  <div className="mt-8 pt-6 border-t border-white/10">
                    ...
                    {option.id === 'desktop' && (
                      <a href="/kim-desktop/README.md" download>
          ...
          <div className="space-y-4">
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-6">
                <h3 className="font-bold text-white mb-2">KIM Agent est-il gratuit ?</h3>
                <p className="text-slate-400">Oui, KIM Agent est entièrement gratuit pour les utilisateurs de World Auto France.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-6">
                ...
                <p className="text-slate-400">KIM Agent fonctionne sur Chrome, Firefox, Safari, Edge et tous les navigateurs modernes. L'installation PWA est optimale sur Chrome et Edge.</p>
              </CardContent>
            </Card>

            <Card className="bg-white/5 border-white/10">
              <CardContent className="p-6">
                <h3 className="font-bold text-white mb-2">Puis-je utiliser KIM Agent hors connexion ?</h3>
