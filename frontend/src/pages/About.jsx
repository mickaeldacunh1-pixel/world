    ...
    <div className="min-h-screen bg-secondary/30 py-12">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 animate-fade-in-up">
          <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4">À propos de World Auto</h1>
        ...
        <Card className="p-8 mb-8 animate-fade-in-up">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            World Auto est né d'une passion pour l'automobile et d'une volonté de simplifier 
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            souhaitiez vendre votre voiture, World Auto est là pour vous accompagner.
          </p>
        </Card>
        ...
        <Card className="p-8 bg-primary text-primary-foreground animate-fade-in-up">
          <h2 className="font-heading text-2xl font-bold mb-6 text-center">World Auto en chiffres</h2>
